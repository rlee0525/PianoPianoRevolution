	  ...
	  _createClass(Game, [{
	    ...
	    value: function draw() {
	      ...
	      this.easySong.map(function (note) {
	        ...
	        if (_this.gameover === false && (note.x === 53 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedQ === true || note.x === 94 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed2 === true || note.x === 135 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedW === true || note.x === 176 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed3 === true || note.x === 217 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedE === true || note.x === 261 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedR === true || note.x === 301 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed5 === true || note.x === 341 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedT === true || note.x === 381 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed6 === true || note.x === 421 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedY === true || note.x === 461 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed7 === true || note.x === 501 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedU === true || note.x === 543 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedI === true || note.x === 584 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed9 === true || note.x === 625 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedO === true || note.x === 666 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed0 === true || note.x === 707 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedP === true)) {
	          _this.score += 1;
	          _this.resultIdx = 2;
	        } else if (note.x === 53 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedQ === false || note.x === 94 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed2 === false || note.x === 135 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedW === false || note.x === 176 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed3 === false || note.x === 217 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedE === false || note.x === 261 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedR === false || note.x === 301 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed5 === false || note.x === 341 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedT === false || note.x === 381 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed6 === false || note.x === 421 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedY === false || note.x === 461 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed7 === false || note.x === 501 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedU === false || note.x === 543 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedI === false || note.x === 584 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed9 === false || note.x === 625 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedO === false || note.x === 666 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressed0 === false || note.x === 707 && note.y < hitbox + 3 && note.y > hitbox - 3 && _this.pressedP === false) {
	          _this.strike -= 1;
	          _this.resultIdx = 0;
	        }
	      });
