...
/***/ function(module, exports, __webpack_require__) {
	...
	var _howlerMin = __webpack_require__(1);
	
	var _howlerMin2 = _interopRequireDefault(_howlerMin);
	
	var _animations = __webpack_require__(3);
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ...
	  function resizeCanvas() {
	    ...
	    (0, _animations2.default)(fireworksCanvas, fireworksCtx);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Animations = function Animations(canvas, ctx) {
	  ...
	  var colorSets = [['#F25F5C', '#FFE066', '#247BA0', '#70C1B3'], ['#B8336A', '#C490D1', '#ACACDE', '#ABDAFC'], ['#C3C3E6', '#D1C8E1', '#B370B0', '#87255B'], ['#7C606B', '#C46BAE', '#EB7BC0', '#EDA4BD'], ['#D72638', '#3F88C5', '#F49D37', '#F22B29'], ['#B5F44A', '#70EE9C', '#79AEA3', '#434371'], ['#DB5461', '#FFD9CE', '#593C8F', '#8EF9F3'], ['#C5FFFD', '#88D9E6', '#8B8BAE', '#526760'], ['#CDF7F6', '#8FB8DE', '#9A94BC', '#9B5094'], ['#ED1C24', '#FDFFFC', '#235789', '#F1D302'], ['#F4F7BE', '#E5F77D', '#DEBA6F', '#823038'], ['#BBE5ED', '#BFBCCB', '#B399A2', '#986C6A'], ['#3B0D11', '#6A3937', '#706563', '#748386'], ['#CAFFD0', '#C9E4E7', '#B4A0E5', '#CA3CFF'], ['#75DDDD', '#508991', '#004346', '#09BC8A'], ['#336699', '#86BBD8', '#9EE493', '#DAF7DC'], ['#DA2C38', '#226F54', '#F4F0BB', '#43291F']];
	  ...
	  var drawRipple = function drawRipple(x, y) {
	    ...
	    ripple.r = 0;
	    ripple.alpha = 1;
	    ripple.color = colors[_animejs2.default.random(0, colors.length - 1)];
	    ripple.lineWidth = 6;
	  ...
	  var drawParticle = function drawParticle(x, y) {
	    var colors = colorSets[0];
	    var particle = {};
	    particle.x = x;
	    particle.y = y;
	    particle.color = colors[_animejs2.default.random(0, colors.length - 1)];
	    particle.radius = _animejs2.default.random(fontSize(), fontSize() * 2);
	  ...
	  var drawParticles = function drawParticles(x, y) {
	    var particles = [];
	    for (var i = 0; i < numParticles; i++) {
	      var particle = drawParticle(x, y);
	  ...
	  var animateParticles = function animateParticles(x, y) {
	    resizeCanvas();
	
	    var particles = drawParticles(x, y);
	    ...
	    var particlesAnimation = (0, _animejs2.default)({
	      ...
	      x: function x(particle) {
	        return particle.x + _animejs2.default.random(-distance, distance);
	      },
	      y: function y(particle) {
	        return particle.y + _animejs2.default.random(-distance, distance);
	      },
	      radius: 0,
	      duration: function duration() {
	        return _animejs2.default.random(1200, 1800);
	      },
	      easing: 'easeOutExpo',
	      complete: removeAnimation
	    });
	
	    var rippleAnimation1 = (0, _animejs2.default)({
	      targets: ripple1,
	      r: function r() {
	        return _animejs2.default.random(fontSize() * 5, fontSize() * 7);
	      },
	      lineWidth: 0,
	      alpha: {
	        value: 0,
	        easing: 'linear',
	        duration: function duration() {
	          return _animejs2.default.random(400, 600);
	        }
	      },
	      duration: function duration() {
	        return _animejs2.default.random(1200, 1800);
	    ...
	    var rippleAnimation2 = (0, _animejs2.default)({
	      targets: ripple2,
	      r: function r() {
	        return _animejs2.default.random(fontSize() * 8, fontSize() * 10);
	      },
	      lineWidth: 0,
	      alpha: {
	        value: 0,
	    ...
	    var rippleAnimation3 = (0, _animejs2.default)({
	      targets: ripple3,
	      r: function r() {
	        return _animejs2.default.random(fontSize() * 11, fontSize() * 13);
	      },
	      lineWidth: 0,
	      alpha: {
	        value: 0,
	  ...
	  var animate = (0, _animejs2.default)({
	    ...
	    update: function update() {
	      ...
	      animations.forEach(function (ani) {
	        ani.animatables.forEach(function (animatable) {
	  ...
	  var updateCoords = function updateCoords() {
	    xCoord = Math.random() * canvas.width / 2 + canvas.width / 2;
	  ...
	  document.addEventListener("keydown", function (e) {
	    ...
	    if (e.keyCode === 81 || e.keyCode === 50 || e.keyCode === 87 || e.keyCode === 51 || e.keyCode === 69 || e.keyCode === 82 || e.keyCode === 53 || e.keyCode === 84 || e.keyCode === 54 || e.keyCode === 89 || e.keyCode === 55 || e.keyCode === 85 || e.keyCode === 73 || e.keyCode === 57 || e.keyCode === 79 || e.keyCode === 48 || e.keyCode === 80) {
	      updateCoords();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lines = __webpack_require__(6);
	var Blocks = __webpack_require__(7);
	var EasySong = __webpack_require__(8);
	var Piano = __webpack_require__(11);
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function draw() {
	      ...
	      var piano = new Piano(this.canvas, this.ctx);
	      piano.draw();
	
	      var lines = new Lines(this.canvas, this.ctx);
	      lines.drawLines();
	
	      var hitbox = this.canvas.height - 298;
	
	      this.easySong.map(function (note) {
	        note.drawNote();
	        _this.drawScore(_this.ctx);
	        _this.drawLife(_this.ctx);
	        _this.drawResult(_this.canvas, _this.ctx, _this.resultIdx);
	        note.y += 2;
	        ...
	        if (_this.gameover === false && (note.x === 53 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedQ === true || note.x === 94 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed2 === true || note.x === 135 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedW === true || note.x === 176 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed3 === true || note.x === 217 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedE === true || note.x === 261 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedR === true || note.x === 301 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed5 === true || note.x === 341 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedT === true || note.x === 381 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed6 === true || note.x === 421 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedY === true || note.x === 461 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed7 === true || note.x === 501 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedU === true || note.x === 543 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedI === true || note.x === 584 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed9 === true || note.x === 625 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedO === true || note.x === 666 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed0 === true || note.x === 707 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedP === true)) {
	          _this.score += 1;
	          _this.resultIdx = 2;
	          _this.ctx.fillStyle = "yellow";
	          _this.ctx.fillRect(50, _this.canvas.height - 300, _this.canvas.width - 100, 30);
	        } else if (note.x === 53 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedQ === false || note.x === 94 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed2 === false || note.x === 135 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedW === false || note.x === 176 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed3 === false || note.x === 217 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedE === false || note.x === 261 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedR === false || note.x === 301 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed5 === false || note.x === 341 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedT === false || note.x === 381 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed6 === false || note.x === 421 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedY === false || note.x === 461 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed7 === false || note.x === 501 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedU === false || note.x === 543 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedI === false || note.x === 584 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed9 === false || note.x === 625 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedO === false || note.x === 666 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressed0 === false || note.x === 707 && note.y < hitbox + 2 && note.y > hitbox - 2 && _this.pressedP === false) {
	          _this.resultIdx = 0;
	          _this.strike -= 1;
	        }
	      });
	    ...
	    key: 'drawWL',
	    value: function drawWL(canvas, ctx, i) {
	      ctx.fillStyle = "black";
	    ...
	    key: 'drawResult',
	    value: function drawResult(canvas, ctx, i) {
...
/***/ function(module, exports) {
	...
	var WhiteKey = function () {
	  function WhiteKey(canvas, ctx, x, y) {
	...
	var BlackKey = function () {
	  function BlackKey(canvas, ctx, x, y) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EasySong = function () {
	  function EasySong(canvas, ctx) {
	    _classCallCheck(this, EasySong);
	
	    this.canvas = canvas;
	    this.ctx = ctx;
	    this.whiteCoords = [53, 135, 217, 261, 341, 421, 501, 543, 625, 707];
	    this.blackCoords = [94, 176, 301, 381, 461, 584, 666];
	    this.yCoords = _lodash2.default.range(0, -20000, -50);
	  }
	
	  _createClass(EasySong, [{
	    key: 'notes',
	    value: function notes() {
	      var easySong = [];
	      var length = this.yCoords.length;
	
	      for (var i = 0; i < 50; i++) {
	        var wx = this.whiteCoords[Math.floor(Math.random() * 10)];
	        var wy = this.yCoords[Math.floor(Math.random() * length)];
	        easySong.push(new Blocks.WhiteKey(this.canvas, this.ctx, wx, wy));
	
	        var bx = this.blackCoords[Math.floor(Math.random() * 7)];
	        var by = this.yCoords[Math.floor(Math.random() * length)];
	...
	var Piano = function () {
	  ...
	  _createClass(Piano, [{
	    ...
	    value: function draw() {
	      ...
	      this.ctx.font = "35px Permanent Marker";
	      this.ctx.fillStyle = "black";
	      this.ctx.fillText("Y", 425, this.canvas.height - 75);
